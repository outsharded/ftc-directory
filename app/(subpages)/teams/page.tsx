      ...
      <div className="ml-16 md:ml-64 p-5 md:p-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
         ...
         >
           ...
           <div
             className={`relative w-full bg-indigo-500 dark:bg-indigo-700 text-white text-center py-10 px-4 ${openSite === index ? "rounded-t-md" : "rounded-md"} flex items-center justify-between`}
           >
             <Link href={site.url}>
             ...
             <button
               className="absolute right-0 h-full w-12 flex items-center justify-center md:hidden bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-700 dark:hover:bg-indigo-800 rounded-r-md"
