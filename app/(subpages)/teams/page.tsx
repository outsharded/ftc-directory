...
export default function Teams() {
  ...
  return (
    <div className="min-h-screen w-screen bg-zinc-100 dark:bg-gray-900 text-gray-900 dark:text-zinc-200 flex transition duration-300">
      ...
      <div className="ml-16 md:ml-64 p-5 md:p-10">
        <h2 className="text-4xl md:text-5xl font-bold text-stone-900 dark:text-zinc-100 mb-4">Team Management</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
         ...
         >
           ...
           <div
             className={`relative w-11/12 md:w-full bg-powercut_pink  text-white text-center py-10 px-4 ${openSite === index ? "rounded-t-md" : "rounded-md"} flex items-center justify-between`}
           >
             <Link href={site.url}>
           ...
           >
             <div
               className="bg-gray-600 dark:bg-gray-800 text-white p-4 w-11/12 md:w-full rounded-b-md"
             >
               <h4 className="text-lg font-semibold">{site.name}</h4>
