...
export default function Home() {
  return (
   <div className="min-h-screen h-screen min-w-screen flex bg-stone-200 text-gray-900 dark:bg-gray-900 dark:text-zinc-200">
      ...
      <table className="table-auto border-collapse border border-slate-500">
        ...
        <tbody>
          <tr>
            ...
            <td className="px-2 border border-slate-700 underline"><Link href="https://discord.com/invite/first-tech-challenge/">discord.com</Link></td>
            <td className="px-2 border border-slate-700 ">Community of students in FTC. Exeptionally useful.</td>
          </tr>
          <tr>
            <td className="px-2 border border-slate-700 font-bold"><Link href="https://gm0.org/">Game Manual 0</Link></td>
            <td className="px-2 border border-slate-700 underline"><Link href="https://gm0.org/">gm0.org</Link></td>  
          ...
          <tr>
            ...
            <td className="px-2 border border-slate-700 underline"><Link href="https://ftc-docs.firstinspires.org/">ftc-docs.firstinspires.org</Link></td>
          ...
          <tr>
            ...
            <td className="px-2 border border-slate-700 underline"><Link href="https://portfolios.hivemindrobotics.net">portfolios.hivemindrobotics.net</Link></td>
          ...
          <tr>
            ...
            <td className="px-2 border border-slate-700 underline"><Link href="https://ftcscout.org/">ftcscout.org</Link></td>
